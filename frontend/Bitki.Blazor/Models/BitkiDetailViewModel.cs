namespace Bitki.Blazor.Models
{
    ...
    /// </summary>
    public class PlantCompoundViewModel
    {
    ...
    /// </summary>
    public class PlantLiteratureViewModel
    {
        public long Id { get; set; }
    ...
    /// <summary>
    /// Full detail ViewModel for Bitki detail page including all fields and related data
    /// </summary>
    public class BitkiDetailViewModel
    {
        // Basic Information
        ...
        public List<PlantCompoundViewModel> Compounds { get; set; } = new();
        public List<PlantImageViewModel> Images { get; set; } = new();
        public List<PlantLiteratureViewModel> Literature { get; set; } = new();

        // Computed properties for display
        public string DisplayName => !string.IsNullOrEmpty(TurkishName) ? TurkishName : LatinName ?? $"Bitki #{Id}";
        public string FullTaxonomy => $"{FamilyName ?? "—"} / {GenusName ?? "—"}";
    }
}
